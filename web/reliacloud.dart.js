...
$$.AppWindowBounds = {
  "": function AppWindowBounds(_jsObject) {
    this._jsObject = _jsObject;
  },
  "super": "ChromeObject"
};
...
$$.FixedSizeListIterator = {
  "": function FixedSizeListIterator(_array, _liblib1$_length, _position, _liblib1$_current) {
    this._array = _array;
...
$$.Closure$resizeWindow = {
  "": function Closure$resizeWindow(call$1, $name) {
    this.call$1 = call$1;
    this.$name = $name;
  },
  "super": "Closure"
...
$.convertArgument = function(argument) {
  ...
  if (!!$.getInterceptor(argument).$isFunction)
...
$.AppWindowBounds$_proxy = function(_jsObject) {
  return new $.AppWindowBounds(_jsObject);
};
...
$.main = function() {
  ...
  t1 = $.get$onClick$x(t1);
  $._EventStreamSubscription$(t1._target, t1._eventType, $.resizeWindow$closure, t1._useCapture);
};

$.resizeWindow = function($event) {
  var t1, bounds, t2, t3, t4;
  t1 = $.AppWindowAppWindow$_proxy($.get$chrome().app.window._jsObject.current())._jsObject;
  bounds = $.AppWindowBounds$_proxy(t1.getBounds());
  t2 = bounds._jsObject;
  t3 = t2.width;
  t4 = $.boundsChange;
  if (typeof t4 !== "number")
  ...
  t2.width = t3 + t4;
  t4 = t2.left;
  t3 = $.$tdiv$n($.boundsChange, 2);
  if (typeof t3 !== "number")
    throw $.iae(t3);
  t2.left = t4 - t3;
  t1.setBounds($.convertArgument(bounds));
  $.boundsChange = $.$mul$n($.boundsChange, -1);
};
...
$.resizeWindow$closure = new $.Closure$resizeWindow($.resizeWindow, "resizeWindow$closure");
...
//@ sourceMappingURL=reliacloud.dart.js.map
