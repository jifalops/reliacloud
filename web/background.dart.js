...
$$._AllMatchesIterator = {
  "": function _AllMatchesIterator(_re, _str, _liblib3$_current) {
    this._re = _re;
    this._str = _str;
...
$$.Stream_elementAt_closure = {
  "": function Stream_elementAt_closure(box_0, future_1) {
    this.box_0 = box_0;
    this.future_1 = future_1;
  },
  "super": "Closure",
...
$$.Stream_elementAt_closure0 = {
  "": function Stream_elementAt_closure(future_2) {
...
$$.Event = {
  "": function Event(_jsObject, _callbackArity) {
...
$$.API_ChromeApp = {
  ...
  API_ChromeApp$1: function(_jsObject) {
    ...
    if (window_object == null)
      throw $.wrapException($.UnsupportedError$("Not supported by current browser."));
...
$$.API_app_window = {
  ...
  create$3: function(url, options, callback) {
    this._jsObject.create(url, $.convertArgument(options), $.convertDartClosureToJS(new $.API_app_window_create___proxy_callback(callback), 1));
  },
  create$2: function(url, options) {
    return this.create$3(url, options, null);
  },
...
$$.API_app_window_create___proxy_callback = {
  "": function API_app_window_create___proxy_callback(callback_0) {
    this.callback_0 = callback_0;
  },
  "super": "Closure",
  call$1: function(created_window) {
    ...
    if (t1 != null)
      t1.call$1($.AppWindowAppWindow$_proxy(created_window));
  },
  $isFunction: true
};
...
$$.Event_app_runtime_onLaunched_addListener___proxy_callback = {
  "": function Event_app_runtime_onLaunched_addListener___proxy_callback(callback_0) {
    this.callback_0 = callback_0;
  },
  "super": "Closure",
...
$$.main_closure = {
  ...
  "super": "Closure",
  call$1: function(launchData) {
    $.get$chrome().app.window.create$2("reliacloud.html", $.AppWindowCreateWindowOptions$(null, null, null, null, null, null, 600, null, null, null, null, null, null, null, null, null, null, null, 800));
  },
  $isFunction: true
};
...
$.convertArgument = function(argument) {
  ...
  if (typeof argument === "object" && argument !== null && !!$.getInterceptor(argument).$isFunction)
    throw $.wrapException($._ExceptionImplementation$("Cannot serialize Function argument " + $.S(argument) + "."));
  return argument;
};
...
$.main = function() {
  ...
  t1.addListener$1(t1, new $.main_closure());
};
